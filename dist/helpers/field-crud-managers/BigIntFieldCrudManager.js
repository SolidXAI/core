...
exports.BigIntFieldCrudManager = void 0;
const class_validator_1 = require("class-validator");
class BigIntFieldCrudManager {
    ...
    applyFormatValidations(fieldValue) {
        const errors = [];
        !this.isBigInt(fieldValue) ? errors.push({ field: this.fieldMetadata.name, error: 'Field is not a bigint' }) : "no errors";
...
exports.BigIntFieldCrudManager = BigIntFieldCrudManager;
//# sourceMappingURL=BigIntFieldCrudManager.js.map