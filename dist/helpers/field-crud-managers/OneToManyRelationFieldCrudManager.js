...
class OneToManyRelationFieldCrudManager {
    constructor(fieldMetadata, entityManager, isInverseSide) {
        this.fieldMetadata = fieldMetadata;
        this.entityManager = entityManager;
        this.isInverseSide = isInverseSide;
        if (isInverseSide == false)
            throw new Error('OneToManyRelationFieldCrudManager can only be used for inverse side of the entity');
    ...
    applyFormatValidations(fieldValue, commandValue, commandFieldName) {
        ...
        if (linkCommands.includes(commandValue)) {
            for (const id of fieldValue) {
                if (!(0, class_validator_1.isInt)(id)) {
...
exports.OneToManyRelationFieldCrudManager = OneToManyRelationFieldCrudManager;
//# sourceMappingURL=OneToManyRelationFieldCrudManager.js.map