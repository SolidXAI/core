...
exports.DecimalFieldCrudManager = void 0;
const class_validator_1 = require("class-validator");
class DecimalFieldCrudManager {
    ...
    applyFormatValidations(fieldValue) {
        const errors = [];
        !(0, class_validator_1.isNumber)(fieldValue) ? errors.push({ field: this.fieldMetadata.name, error: 'Field is not a decimal' }) : "no errors";
...
exports.DecimalFieldCrudManager = DecimalFieldCrudManager;
//# sourceMappingURL=DecimalFieldCrudManager.js.map