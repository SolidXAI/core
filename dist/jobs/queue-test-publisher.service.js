...
let TestQueuePublisher = class TestQueuePublisher extends rabbitmq_publisher_service_1.RabbitMqPublisher {
    ...
    options() {
        return {
            ...test_queue_config_1.default
        };
    }
};
exports.TestQueuePublisher = TestQueuePublisher;
exports.TestQueuePublisher = TestQueuePublisher = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [mq_message_service_1.MqMessageService,
        mq_message_queue_service_1.MqMessageQueueService])
], TestQueuePublisher);
//# sourceMappingURL=queue-test-publisher.service.js.map