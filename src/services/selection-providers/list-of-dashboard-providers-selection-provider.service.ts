...
@SelectionProvider()
@Injectable()
export class ListOfDashboardProvidersSelectionProvider implements ISelectionProvider<ISelectionProviderContext> {
    ...
    name(): string {
        return 'ListOfDashboardProvidersSelectionProvider';
    }
