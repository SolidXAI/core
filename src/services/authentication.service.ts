...
export class AuthenticationService {
    ...
    async signupForExtensionUser<T extends User>(signUpDto: SignUpDto, extensionUserRepo: Repository<T>): Promise<T> {
        try {
            // Sign up the extension user
            const user = extensionUserRepo.create() as T;
            await this.populateForSignup<T>(user, signUpDto);
