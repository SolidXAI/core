...
@Injectable()
export class SHA256HashComputationProvider implements IEntityPreComputeFieldProvider<any, any> {
    constructor() { }
    ...
    async preComputeValue(entity: any, computedFieldMetadata: ComputedFieldMetadata<HashComputationOptions>): Promise<void> {
        ...
        const hash = this.compute(valueToHash, computedFieldValueProviderCtxt);
