...
export const iamConfig = registerAs('iam', () => {
    return {
        ...
        sendWelcomeEmailOnSignup: (process.env.SEND_WELCOME_EMAIL_ON_SIGNUP ?? 'false').toLowerCase() === 'true',
        sendWelcomeSmsOnSignup: (process.env.SEND_WELCOME_SMS_ON_SIGNUP ?? 'false').toLowerCase() === 'true',
    };
})
