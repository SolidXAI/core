...
@Injectable()
export class GenerateCodeSubscriberRedis extends RedisSubscriber<CodeGenerationOptions> {
    private readonly generateCodeSubscriberLogger = new Logger(GenerateCodeSubscriberRedis.name);
