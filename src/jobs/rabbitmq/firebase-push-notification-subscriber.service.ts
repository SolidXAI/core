...
import queueOptions from "./firebase-push-notification-queue-options";

@Injectable()
export class FirebasePushNotificationQueueSubscriberRabbitmq extends RabbitMqSubscriber<any> {
  constructor(
