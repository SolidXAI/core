...
export class AgentEventController {
  ...
  @Post('/bulk')
  @UseInterceptors(AnyFilesInterceptor())
  insertMany(@Body() createDtos: CreateAgentEventDto[], @UploadedFiles() filesArray: Express.Multer.File[][] = []) {
  ...
  @Put(':id')
  @UseInterceptors(AnyFilesInterceptor())
  update(@Param('id') id: number, @Body() updateDto: UpdateAgentEventDto, @UploadedFiles() files: Array<Express.Multer.File>) {
  ...
  @Patch(':id')
  @UseInterceptors(AnyFilesInterceptor())
  partialUpdate(@Param('id') id: number, @Body() updateDto: UpdateAgentEventDto, @UploadedFiles() files: Array<Express.Multer.File>) {
